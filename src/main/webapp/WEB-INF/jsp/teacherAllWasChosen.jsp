    ...
    <script>
        ...
        function formatTitle(val, row) {
            ...
            if(row.auditStatusId == null){
                ...
                return "<a target = '_self'   style = 'text-decoration:none'href = '' > 查看详情 </a> "
            }else if(row.auditStatusId == 3){
                return "<a target = '_self'   style = 'text-decoration:none'href = '' > 查看详情 </a> <a target = '_self'   style = 'text-decoration:none'href = '/task/assignmentbook/form?assignmentbookid=" + row.assignmentbookId + "' > 修改后再提交 </a>"
