...
<div >
    ...
    <img src="/static/png/401.png" style="width: 100%;height: 100%">
</div>
...
<%--&lt;%&ndash;            <img class="mb-4" src="/static/bootstrap-4.5.3-examples/assets/brand/bootstrap-solid.svg" alt="" width="72"&ndash;%&gt;--%>
<%--&lt;%&ndash;                 height="72">&ndash;%&gt;--%>
<%--            <h1 class="h3 mb-3 font-weight-normal">用户登录</h1>--%>
<%--            &lt;%&ndash;        <p></p>&ndash;%&gt;--%>
<%--        </div>--%>
<%--        &lt;%&ndash;这里使用了input type="email"进行判别是否是邮箱的格式&ndash;%&gt;--%>
<%--        &lt;%&ndash;  <label for=""> 中for的作用是和哪个表单元素绑定 &ndash;%&gt;--%>
<%--        &lt;%&ndash;    <label for="inputEmail">则是与<input type="text" id="inputEmail" class="form-control" placeholder="Email address" required autofocus>来进行绑定&ndash;%&gt;--%>
...
<%--&lt;%&ndash;        <p class="mt-5 mb-3 text-muted text-center">&copy; 2017-2020</p>&ndash;%&gt;--%>
<%--    </form>--%>
...
<%--                <h2></h2>--%>
<%--                <p></p>--%>
<%--                &lt;%&ndash;                <p><a class="btn btn-secondary" href="#" role="button">View details &raquo;</a></p>&ndash;%&gt;--%>
<%--            </div>--%>
<%--            <div class="col-md-4">--%>
<%--                <h2></h2>--%>
<%--                <p></p>--%>
