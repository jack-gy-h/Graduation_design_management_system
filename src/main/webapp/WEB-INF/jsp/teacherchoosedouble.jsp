    ...
    <script>
        ...
        function formatTitle(val, row) {
            if (row.teacherchoosestatusId == 1) {
                return "<a target = '_self'   style = 'text-decoration:none'href = '/teacher/task/chosenstudent?taskid=" + row.id + "&choosestatusId="+row.teacherchoosestatusId+"&studentId="+row.studentId+"&status=2' > 通过 </a>&nbsp;<a target = '_self'   style = 'text-decoration:none'href = '/teacher/task/chosenstudent?taskid=" + row.id + "&choosestatusId=" + row.teacherchoosestatusId + "&studentId=" + row.studentId + "&status=3' > 不通过 </a>"
