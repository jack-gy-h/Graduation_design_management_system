...
INSERT INTO `role` VALUES ('1', '系统管理员', 'dept', '1', '2013-05-27 08:00:00', '1', '2013-05-27 08:00:00', NULL, '1');
...
CREATE TABLE `user`  (
  ...
  `office_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'admin', '59456ce5a80e467444187cfc9a643f52', 'ADMIN', '34', NULL, NULL, NULL, '', NULL, NULL, '0');
INSERT INTO `user` VALUES ('2', '606300', '454cd1d42d58d740c69edeef3d3ebe0a', 'TEACHER', '33', NULL, NULL, NULL, '', NULL, NULL, '0');
INSERT INTO `user` VALUES ('3', '17034480134', '454cd1d42d58d740c69edeef3d3ebe0a', 'STUDENT', '32', NULL, NULL, NULL, '', NULL, NULL, '0');
INSERT INTO `user` VALUES ('4', '17034480135', '454cd1d42d58d740c69edeef3d3ebe0a', '', '31', NULL, NULL, NULL, '', NULL, NULL, '0');
INSERT INTO `user` VALUES ('5', 'superadmin', '7edaed8f28b43651fe3ee90181754d63', 'SUPERADMIN', '30', NULL, '', '', '', NULL, NULL, '0');
INSERT INTO `user` VALUES ('6', '170304480136', '454cd1d42d58d740c69edeef3d3ebe0a', '', '29', NULL, '', '', '', NULL, NULL, '0');
...
CREATE TABLE `user_copy1`  (
  ...
  `username` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '用户名',
  `password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '用户密码',
  `identity_id` int(255) NULL DEFAULT NULL COMMENT '身份号',
  `gender` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '性别',
  `email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '邮箱',
  `identity` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '身份',
  `del_flag` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0' COMMENT '删除标记',
...
-- ----------------------------
INSERT INTO `user_copy1` VALUES ('1', '', 'admin', '59456ce5a80e467444187cfc9a643f52', 34, NULL, NULL, 'ADMIN', '0');
INSERT INTO `user_copy1` VALUES ('2', '', '606300', '454cd1d42d58d740c69edeef3d3ebe0a', 34, NULL, NULL, 'TEACHER', '0');
INSERT INTO `user_copy1` VALUES ('3', '', '17034480134', '454cd1d42d58d740c69edeef3d3ebe0a', 34, NULL, NULL, 'STUDENT', '0');
INSERT INTO `user_copy1` VALUES ('4', '', '17034480135', '454cd1d42d58d740c69edeef3d3ebe0a', 22, NULL, NULL, '', '0');
INSERT INTO `user_copy1` VALUES ('5', '', 'superadmin', '7edaed8f28b43651fe3ee90181754d63', 44, '', '', 'SUPERADMIN', '0');
INSERT INTO `user_copy1` VALUES ('6', '', '170304480136', '454cd1d42d58d740c69edeef3d3ebe0a', 23, '', '', '', '0');
...
-- ----------------------------
-- Table structure for user_info_all_copy1
-- ----------------------------
DROP TABLE IF EXISTS `user_info_all_copy1`;
CREATE TABLE `user_info_all_copy1`  (
  `user_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '用户id',
  `college_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '学院id,实际上是机构id',
  `major_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '专业id,实际上是机构id',
  `identitys_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '身份id,用于看是否需要显示专业',
...
-- ----------------------------
-- Records of user_info_all_copy1
-- ----------------------------
